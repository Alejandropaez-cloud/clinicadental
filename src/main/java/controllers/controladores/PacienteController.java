...
import javax.persistence.EntityManager; // Gestiona la conexión y transacciones con la BD
 ...
 * Cada operación abre una transacción, ejecuta la operación y la confirma o revierte.
 */
public class PacienteController {
     ...
     * Abre una transacción, persiste el objeto y confirma los cambios.
     */
     ...
     * Usa consultas nativas SQL porque necesita eliminar en un orden específico
    ...
    public void deleteAll() {
        ...
        try {
            tx.begin(); // Inicia la transacción
            // Orden específico de eliminación para respetar las claves foráneas:
